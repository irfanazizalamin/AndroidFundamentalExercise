package com.dicoding.fundamentalandroid.UnitTesting
...
class UnitTestingMainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_unit_testing_main)
            ...
            height.isEmpty() -> edtHeight.error = "Field ini tidak boleh kosong"
                ...
                when (v?.id) {
                    ...
                    R.id.btn_calculate_surface_area -> {
                        ...
                        tvResult.text = surfaceArea.toString()
                        gone()
                    }
                    R.id.btn_calculate_circumference -> {
                        val circumference = mainViewModel.getCircumference()
                        tvResult.text = circumference.toString()
                        gone()
                    }
